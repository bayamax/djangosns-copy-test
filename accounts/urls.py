...
urlpatterns = [
    ...
    path('profile/<str:comid>/community_follow/', views.mycommunity_follow_view, name='mycommunity_follow'),
    path('profile/<str:comid>/community_unfollow/', views.mycommunity_unfollow_view, name='mycommunity_unfollow'),
